...
De korringeringar som gjorts i DiVA under året har inte påverket antalet publikationer jämfört med årsredvisningen 2021.
...
names(oa_art_table) <- c("Year", "ref_articles", "oa_articles")
