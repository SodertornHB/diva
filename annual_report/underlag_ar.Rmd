...
header-includes: 
  ...
  \rhead{Biblioteket \myformat\today} 
...
oa_table <- oa_table[c(1,6,5,4,3,2)] %>%
  rename("Publicering med öppen tillgång" = PublicationType)
...
write.csv(oa_table, "OA_underlag_årsredovisningen.csv")
sh_archive_resource("OA_underlag_årsredovisningen.csv")
